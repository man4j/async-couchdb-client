...
import com.equiron.yns.provider.JdkHttpClientProvider;
import com.equiron.yns.provider.OkHttpClientProvider;
import com.equiron.yns.util.NamedStrategy;
import com.equiron.yns.util.ReflectionUtils;
import com.equiron.yns.util.StreamResponse;
import com.equiron.yns.util.UrlBuilder;
import com.equiron.yns.view.YnsBuiltInView;
...
import com.equiron.yns.view.YnsView;
...
public class YnsDb implements AutoCloseable {
    @Autowired
    private volatile com.equiron.yns.YnsDbConfig config;
    ...
    */
    ...
    private void applyConfig() {
        ...
        if (getClass().isAnnotationPresent(com.equiron.yns.annotation.YnsDbConfig.class)) {
    ...
    private void addSecurity() {
        try {
            ...
            if (getClass().isAnnotationPresent(YnsSecurity.class)) {
                ...
                securityObject.setAdmins(new com.equiron.yns.json.security.YnsSecurityPattern(new HashSet<>(Arrays.asList(adminsPattern.names())), new HashSet<>(Arrays.asList(adminsPattern.roles()))));
                securityObject.setMembers(new com.equiron.yns.json.security.YnsSecurityPattern(new HashSet<>(Arrays.asList(membersPattern.names())), new HashSet<>(Arrays.asList(membersPattern.roles()))));
    ...
    protected void synchronizeReplicationDocs() {
        ...
        com.equiron.yns.YnsDbConfig _config = new com.equiron.yns.YnsDbConfig.Builder().setHost(host)
                                                                                       .setPort(port)
                                                                                       .setUser(user)
