...
public class CouchDbAdmin extends CouchDbBase {
    ...
    public class CouchDbAdminAsyncOperations {
         ...
         * when used in URLs.
         */
        public CompletableFuture<List<String>> getListDbsAsync() {
            return FutureUtils.toCompletable(httpClient.prepareRequest(prototype)
         ...
         */
        public CompletableFuture<List<CouchDbTaskInfo>> getActiveTasks() {
            return FutureUtils.toCompletable(httpClient.prepareRequest(prototype)
         ...
         */
        public CompletableFuture<Boolean> deleteDb(String dbName) {
            return FutureUtils.toCompletable(httpClient.prepareRequest(prototype)
